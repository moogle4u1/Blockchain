...
function _picocli_besu() {
  ...
  local flag_opts="--p2p-enabled --discovery-enabled --remote-connections-limit-enabled --random-peer-priority-enabled --graphql-http-enabled --engine-jwt-disabled --rpc-http-enabled --rpc-http-authentication-enabled --rpc-http-tls-enabled --rpc-http-tls-client-auth-enabled --rpc-http-tls-ca-clients-enabled --rpc-ws-enabled --rpc-ws-authentication-enabled --privacy-tls-enabled --privacy-enabled --privacy-multi-tenancy-enabled --privacy-enable-database-migration --privacy-flexible-groups-enabled --metrics-enabled --metrics-push-enabled --color-enabled --miner-enabled --miner-stratum-enabled --pruning-enabled --permissions-nodes-config-file-enabled --permissions-accounts-config-file-enabled --permissions-nodes-contract-enabled --permissions-accounts-contract-enabled --revert-reason-enabled --auto-log-bloom-caching-enabled -h --help -V --version --compatibility-eth64-forkid-enabled --strict-tx-replay-protection-enabled"
  local arg_opts="--config-file --data-path --genesis-file --identity --bootnodes --p2p-host --p2p-interface --p2p-port --max-peers --remote-connections-max-percentage --discovery-dns-url --banned-node-ids --banned-node-id --sync-mode --fast-sync-min-peers --network --nat-method --network-id --graphql-http-host --graphql-http-port --graphql-http-cors-origins --engine-rpc-port --engine-jwt-secret --engine-host-allowlist --rpc-http-host --rpc-http-port --rpc-http-max-active-connections --rpc-http-cors-origins --rpc-http-api --rpc-http-apis --rpc-http-api-method-no-auth --rpc-http-api-methods-no-auth --rpc-http-authentication-credentials-file --rpc-http-authentication-jwt-public-key-file --rpc-http-authentication-jwt-algorithm --rpc-http-tls-keystore-file --rpc-http-tls-keystore-password-file --rpc-http-tls-known-clients-file --rpc-http-tls-protocol --rpc-http-tls-protocols --rpc-http-tls-cipher-suite --rpc-http-tls-cipher-suites --rpc-ws-authentication-jwt-algorithm --rpc-ws-host --rpc-ws-port --rpc-ws-max-frame-size --rpc-ws-max-active-connections --rpc-ws-api --rpc-ws-apis --rpc-ws-api-methods-no-auth --rpc-ws-api-method-no-auth --rpc-ws-authentication-credentials-file --rpc-ws-authentication-jwt-public-key-file --privacy-tls-keystore-file --privacy-tls-keystore-password-file --privacy-tls-known-enclave-file --privacy-url --privacy-public-key-file --privacy-marker-transaction-signing-key-file --metrics-protocol --metrics-host --metrics-port --metrics-category --metrics-categories --metrics-push-host --metrics-push-port --metrics-push-interval --metrics-push-prometheus-job --host-allowlist --reorg-logging-threshold --miner-stratum-host --miner-stratum-port --miner-coinbase --miner-extra-data --min-gas-price --rpc-tx-feecap --min-block-occupancy-ratio --permissions-nodes-config-file --permissions-accounts-config-file --permissions-nodes-contract-address --permissions-nodes-contract-version --permissions-accounts-contract-address --required-blocks --required-block --target-gas-limit --tx-pool-max-size --tx-pool-hashes-max-size --tx-pool-retention-hours --tx-pool-price-bump --key-value-storage --security-module --pruning-blocks-retained --pruning-block-confirmations --pid-path --api-gas-price-blocks --api-gas-price-percentile --api-gas-price-max --static-nodes-file --ethstats --ethstats-contact --node-private-key-file --logging -l --data-storage-format --bonsai-maximum-back-layers-to-load"
  local MODE_option_args="FULL FAST X_SNAP" # --sync-mode values
